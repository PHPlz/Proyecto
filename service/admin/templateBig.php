...
<body>
  ...
  $str_datos .= '      <a class="nav-item nav-link active" href="admReqHandler.php?type=set-db">Reset DB</a>';
  $str_datos .= '      <a class="nav-item nav-link active" href="admReqHandler.php?type=add-admin">Agregar Administrador</a>';
